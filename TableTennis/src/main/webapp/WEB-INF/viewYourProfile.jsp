...
<div class="col-sm-10">
<input type="text" readonly class="form-control-plaintext" id="street" value="${user.address.street}">
</div>
<div class="form-group row">
<div class="col">
...
<div class="col-sm-10">
<input type="text" readonly class="form-control-plaintext" id="staticPassword" value="${user.email}">
</div>
<div class="form-group row">
